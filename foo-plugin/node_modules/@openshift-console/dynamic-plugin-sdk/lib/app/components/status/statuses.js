 ...
 * ```
 */
export const ErrorStatus = (props) => (_jsx(GenericStatus, { ...props, Icon: RedExclamationCircleIcon }));
 ...
 * ```
 */
export const InfoStatus = (props) => (_jsx(GenericStatus, { ...props, Icon: BlueInfoCircleIcon }));
 ...
 * ```
 */
export const ProgressStatus = (props) => (_jsx(GenericStatus, { ...props, Icon: InProgressIcon }));
 ...
 * ```
 */
export const SuccessStatus = (props) => (_jsx(GenericStatus, { ...props, Icon: GreenCheckCircleIcon }));
