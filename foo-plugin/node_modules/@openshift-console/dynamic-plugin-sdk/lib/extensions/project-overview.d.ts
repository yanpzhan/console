...
export type ProjectOverviewInventoryItem = ExtensionDeclaration<'console.project-overview/inventory-item', {
...
export type ProjectOverviewUtilizationItem = ExtensionDeclaration<'console.project-overview/utilization-item', {
...
export declare const isProjectOverviewInventoryItem: (e: Extension) => e is ProjectOverviewInventoryItem;
export declare const isProjectOverviewUtilizationItem: (e: Extension) => e is ProjectOverviewUtilizationItem;
