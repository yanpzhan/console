...
export type PVCCreateProp = ExtensionDeclaration<'console.pvc/create-prop', {
...
export type PVCAlert = ExtensionDeclaration<'console.pvc/alert', {
    /** The alert component. */
...
export type PVCStatus = ExtensionDeclaration<'console.pvc/status', {
...
export type PVCDelete = ExtensionDeclaration<'console.pvc/delete', {
