...
export const k8sCreate = (model, data, opts = {}) => {
    return coFetchJSON.post(resourceURL(model, Object.assign({ ns: data?.metadata?.namespace }, opts)), data, null, null);
};
/**
 ...
 * In case of failure promise gets rejected with HTTP error response.
 */
export const k8sUpdate = (model, data, ns, name, opts) => coFetchJSON.put(resourceURL(model, {
