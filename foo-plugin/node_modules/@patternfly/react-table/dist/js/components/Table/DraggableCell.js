...
const DraggableCell = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(Button_1.Button, Object.assign({ id: id, variant: "plain", className: className, type: "button", "aria-label": ariaLabel || `Draggable row draggable button`, onClick: onClick }, props, { icon: (0, jsx_runtime_1.jsx)(grip_vertical_icon_1.default, {}) })));
};
