...
const TbodyBase = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)("tbody", Object.assign({ role: "rowgroup", className: (0, react_styles_1.css)(table_1.default.tableTbody, className, isExpanded && table_1.default.modifiers.expanded, isOddStriped && table_1.default.modifiers.striped, isEvenStriped && table_1.default.modifiers.stripedEven), ref: innerRef }, props, { children: children })));
};
exports.Tbody = (0, react_1.forwardRef)((props, ref) => ((0, jsx_runtime_1.jsx)(TbodyBase, Object.assign({}, props, { innerRef: ref }))));
