...
const HeaderCell = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(components_1.Th, Object.assign({}, props, { scope: scope, tooltip: tooltip, onMouseEnter: onMouseEnter, textCenter: textCenter, component: component, className: className, children: children })));
};
