...
const CardActions = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: (0, react_styles_1.css)(card_1.default.cardActions, hasNoOffset && card_1.default.modifiers.noOffset, className) }, props, { children: children })));
};
