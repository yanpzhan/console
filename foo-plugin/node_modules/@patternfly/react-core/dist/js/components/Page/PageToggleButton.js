...
const PageToggleButton = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(PageContext_1.PageContextConsumer, { children: ({ isManagedSidebar, onSidebarToggle: managedOnSidebarToggle, isSidebarOpen: managedIsSidebarOpen }) => {
            ...
            return ((0, jsx_runtime_1.jsx)(Button_1.Button, Object.assign({ id: id, onClick: sidebarToggle, "aria-label": "Side navigation toggle", "aria-expanded": sidebarOpen ? 'true' : 'false', variant: Button_1.ButtonVariant.plain }, props, { children: children })));
        } }));
};
