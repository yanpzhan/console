...
const CodeBlockAction = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: (0, react_styles_1.css)(`${code_block_1.default.codeBlockActions}-item`, className) }, props, { children: children })));
};
