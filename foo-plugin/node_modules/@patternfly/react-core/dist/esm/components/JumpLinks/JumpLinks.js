...
export const JumpLinks = (_a) => {
    ...
    return (_jsx("nav", Object.assign({ className: css(styles.jumpLinks, isCentered && styles.modifiers.center, isVertical && styles.modifiers.vertical, formatBreakpointMods(expandable, styles), isExpanded && styles.modifiers.expanded, className), "aria-label": ariaLabel, ref: navRef }, props, { children: _jsxs("div", { className: styles.jumpLinksMain, children: [_jsxs("div", { className: css(`${styles.jumpLinks}__header`), children: [expandable && (_jsx("div", { className: styles.jumpLinksToggle, children: _jsx(Button, { variant: "plain", onClick: () => setIsExpanded(!isExpanded), "aria-label": toggleAriaLabel, "aria-expanded": isExpanded, icon: _jsx("span", { className: styles.jumpLinksToggleIcon, children: _jsx(AngleRightIcon, {}) }), children: label && label }) })), label && alwaysShowLabel && _jsx("div", { className: css(styles.jumpLinksLabel), children: label })] }), _jsx("ul", { className: styles.jumpLinksList, role: "list", children: cloneChildren(children) })] }) })));
};
