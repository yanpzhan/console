...
class ContextBody extends react_1.Component {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        return ((0, jsx_runtime_1.jsx)(react_1.Fragment, { children: mappedRows && ((0, jsx_runtime_1.jsx)(base_1.Body, Object.assign({}, props, { mappedRows: mappedRows, rows: mappedRows, onRow: this.onRow, rowKey: rowKey, className: className }))) }));
    }
}
const TableBody = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(TableContext_1.TableContext.Consumer, { children: (_a) => {
            var { headerData = [], rows = [] } = _a, rest = tslib_1.__rest(_a, ["headerData", "rows"]);
            return ((0, jsx_runtime_1.jsx)(ContextBody, Object.assign({ headerData: headerData, rows: rows, onRow: onRow, className: className, rowKey: rowKey, onRowClick: onRowClick }, props, rest, { children: children })));
        } }));
};
