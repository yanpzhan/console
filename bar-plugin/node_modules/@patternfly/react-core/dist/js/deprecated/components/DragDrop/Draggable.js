...
const cssDraggingBackgroundColor = { name: `--${drag_drop_1.default.draggable}--m-dragging--BackgroundColor` };
...
const Draggable = (_a) => {
    ...
    let [style, setStyle] = (0, react_1.useState)(styleProp);
    /* eslint-enable prefer-const */
    const [isDragging, setIsDragging] = (0, react_1.useState)(false);
    const [isValidDrag, setIsValidDrag] = (0, react_1.useState)(true);
    const { zone, droppableId } = (0, react_1.useContext)(DroppableContext_1.DroppableContext);
    const { onDrag, onDragMove, onDrop } = (0, react_1.useContext)(DragDrop_1.DragDropContext);
    ...
    function getSourceAndDest() {
        ...
        const dest = hoveringDroppableId !== null
            ? {
    ...
    const childProps = Object.assign({ 'data-pf-draggable-zone': isDragging ? null : zone, draggable: true, className: (0, react_styles_1.css)(drag_drop_1.default.draggable, isDragging && drag_drop_1.default.modifiers.dragging, !isValidDrag && drag_drop_1.default.modifiers.dragOutside, className), onDragStart,
        onTransitionEnd,
        style }, props);
    return ((0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [isDragging && ((0, jsx_runtime_1.jsx)("div", Object.assign({ draggable: true }, props, { style: Object.assign(Object.assign({}, styleProp), { visibility: 'hidden' }), children: children }))), hasNoWrapper ? ((0, react_1.cloneElement)(children, childProps)) : ((0, jsx_runtime_1.jsx)("div", Object.assign({}, childProps, { children: children })))] }));
};
