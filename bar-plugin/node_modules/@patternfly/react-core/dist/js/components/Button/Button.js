...
const ButtonBase = (_a) => {
    ...
    const _icon = icon && ((0, jsx_runtime_1.jsx)("span", { className: (0, react_styles_1.css)(button_1.default.buttonIcon, children && button_1.default.modifiers[isIconAlignedAtEnd ? 'end' : 'start']), children: icon }));
