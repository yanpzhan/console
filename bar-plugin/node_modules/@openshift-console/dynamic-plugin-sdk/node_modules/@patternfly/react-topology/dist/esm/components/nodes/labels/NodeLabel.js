...
const NodeLabel = (_a) => {
    var _b;
    var { children, className, paddingX = 0, paddingY = 0, cornerRadius = 4, x = 0, y = 0, position = LabelPosition.bottom, centerLabelOnEdge, secondaryLabel, status, badge, badgeColor, badgeTextColor, badgeBorderColor, badgeClassName, badgeLocation = BadgeLocation.inner, labelIconClass, labelIcon, labelIconPadding = 4, truncateLength, dragRef, hover, dragging, edgeDragging, dropTarget, onContextMenu, contextMenuOpen, hideContextMenuKebab, actionIcon, actionIconClassName, onActionIconClick, boxRef } = _a, other = __rest(_a, ["children", "className", "paddingX", "paddingY", "cornerRadius", "x", "y", "position", "centerLabelOnEdge", "secondaryLabel", "status", "badge", "badgeColor", "badgeTextColor", "badgeBorderColor", "badgeClassName", "badgeLocation", "labelIconClass", "labelIcon", "labelIconPadding", "truncateLength", "dragRef", "hover", "dragging", "edgeDragging", "dropTarget", "onContextMenu", "contextMenuOpen", "hideContextMenuKebab", "actionIcon", "actionIconClassName", "onActionIconClick", "boxRef"]);
    ...
    return (React.createElement("g", { className: className, ref: refs, transform: `translate(${startX}, ${startY})` },
        ...
        textSize && (React.createElement("rect", { ref: boxRef, className: css(styles.topologyNodeLabelBackground), key: `rect-${filterId}-${width}`, filter: filterId && createSvgIdUrl(filterId), x: 0, y: 0, width: width, height: backgroundHeight, rx: cornerRadius, ry: cornerRadius })),
