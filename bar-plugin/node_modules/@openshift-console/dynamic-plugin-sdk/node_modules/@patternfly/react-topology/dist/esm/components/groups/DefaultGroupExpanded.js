...
const DefaultGroupExpanded = ({ className, element, collapsible, selected, onSelect, hover, label, secondaryLabel, showLabel = true, showLabelOnHover, truncateLength, dndDropRef, droppable, canDrop, dropTarget, onContextMenu, contextMenuOpen, hideContextMenuKebab, dragging, dragNodeRef, badge, badgeColor, badgeTextColor, badgeBorderColor, badgeClassName, badgeLocation, labelClassName, labelIconClass, labelIcon, labelPosition, labelIconPadding, onCollapseChange, hulledOutline = true, borderRadius = 16 }) => {
    var _a;
    ...
    const groupLabel = (showLabel || (showLabelOnHover && isHover)) && (label || element.getLabel()) ? (React.createElement("g", { ref: labelHoverRef, transform: isHover ? `scale(${labelScale})` : undefined },
        React.createElement(NodeLabel, { className: css(styles.topologyGroupLabel, labelClassName), x: startX * labelPositionScale, y: startY * labelPositionScale, paddingX: 8, paddingY: 5, dragRef: dragNodeRef ? dragLabelRef : undefined, status: element.getNodeStatus(), secondaryLabel: secondaryLabel, truncateLength: truncateLength, badge: badge, badgeColor: badgeColor, badgeTextColor: badgeTextColor, badgeBorderColor: badgeBorderColor, badgeClassName: badgeClassName, badgeLocation: badgeLocation, labelIconClass: labelIconClass, labelIcon: labelIcon, labelIconPadding: labelIconPadding, onContextMenu: onContextMenu, contextMenuOpen: contextMenuOpen, hideContextMenuKebab: hideContextMenuKebab, hover: isHover || labelHover, actionIcon: collapsible ? React.createElement(CollapseIcon, null) : undefined, onActionIconClick: () => onCollapseChange(element, true) }, label || element.getLabel()))) : null;
