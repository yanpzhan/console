...
export declare enum ClusterConfigurationFieldType {
    text = "text",
    checkbox = "checkbox",
    dropdown = "dropdown",
    custom = "custom"
...
export type ClusterConfigurationGroup = ExtensionDeclaration<'console.cluster-configuration/group', {
...
export type ClusterConfigurationItem = ExtensionDeclaration<'console.cluster-configuration/item', {
...
export declare const isClusterConfigurationGroup: (e: Extension) => e is ClusterConfigurationGroup;
export declare const isClusterConfigurationItem: (e: Extension) => e is ClusterConfigurationItem;
