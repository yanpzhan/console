...
export type AlertingRulesSourceExtension = ExtensionDeclaration<'console.alerts/rules-source', {
...
type AlertingRuleChartProps = {
    rule?: Rule;
};
/** Metric charts for alerting rules from additional sources other than Prometheus */
export type AlertingRuleChartExtension = ExtensionDeclaration<'console.alerts/rules-chart', {
