...
import { UseK8sModel, K8sResourceKindReference, K8sGroupVersionKind } from '../../../extensions/console-types';
export declare const getK8sModel: (k8s: any, k8sGroupVersionKind?: K8sResourceKindReference | K8sGroupVersionKind) => K8sModel;
/**
