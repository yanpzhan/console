        ...
        "properties": {
          ...
          "properties": {
            ...
            "page": {
              ...
              "additionalProperties": false,
              "description": "The page to be show in horizontal tab. It takes tab name as name and href of the tab. Note: any special characters in href are encoded, and href is treated as a single path element."
            },
            "component": {
              "$ref": "#/definitions/EncodedCodeRef",
              "description": "The component to be rendered when the route matches."
